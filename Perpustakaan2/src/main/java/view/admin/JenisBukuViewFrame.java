...
public class JenisBukuViewFrame extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        ArrayList<JenisBuku> list = JenisBuku.search(tfCari2.getText());
        tampilkanData(list);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        if(barisTerpilih >= 0){
            ...
            JenisBukuAddFrame JenisBukuAddFrame = new JenisBukuAddFrame(JenisBuku);
            JenisBukuAddFrame.setVisible(true);
        } else {
    ...
    public void tampilkanData(ArrayList<JenisBuku> list){
